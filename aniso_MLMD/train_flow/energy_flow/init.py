...
def get_parameters():
    ...
    # project parameters
    parameters["project"] = ["pps-energy-Apr11"]
    parameters["group"] = ["energy-20N"]
    parameters["notes"] = ["Learning pps 300 forces"]
    parameters["tags"] = ["w/o initialization"]
    parameters["target"] = ["energy"]
    parameters["log"] = [True]
    ...
    parameters["prior_energy_n"] = [2]
    parameters["prior_force"] = [True]
...
def main(root=None):
    project = signac.init_project("PPS-E", root=root)  # Set the signac project name
